...
const Insights = () => {
  ...
  const {
    totalReviews = "0",
    summarizedText = `Review's not Avialble Yet`,
    averageRating = 0,
  } = insightsData || {};
    ...
    <div className="bg-slate-950 py-12">
      <div className="container mx-auto px-4 max-w-screen-lg">
        ...
        {auth ? (
          ...
          <p className="text-center w-full md:text-2xl sm:text-xl text-lg font-semibold text-white bg-slate-950 rounded-[30px] p-5 mt-[50px]">
